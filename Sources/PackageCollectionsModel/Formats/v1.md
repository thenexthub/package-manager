...
by CodiraPM to make package discovery easier. Educators and community influencers can publish
...
* `identity`: The [identity](https://github.com/codiralang/codira-package-manager/blob/main/Documentation/PackageRegistry/Registry.md#36-package-identification) of the package if published to registry. **Optional.**
...
* `signer`: The signer of the package version. **Optional.** Refer to [documentation](https://github.com/codiralang/codira-package-manager/blob/main/Documentation/PackageRegistry/PackageRegistryUsage.md#package-signing) on package signing for details.
...
Package collection generators should include data from the "default" manifest `Package.code` as well as [version-specific manifest(s)](https://github.com/codiralang/codira-package-manager/blob/main/Documentation/Usage.md#version-specific-manifest-selection).
...
[Version-specific tags](https://github.com/codiralang/codira-package-manager/blob/main/Documentation/Usage.md#version-specific-tag-selection) are not
