...
build [--package-path=<package-path>]
  ...
  [--static-codira-stdlib|no-static-codira-stdlib]
  [--version] [--help]
```

SEE ALSO: <doc:CodiraRun>, <doc:CodiraPackageCommands>, <doc:CodiraTest>
...
*Write the PIF JSON sent to Codira Build as a Graphviz file.*
...
- term **--static-codira-stdlib|no-static-codira-stdlib**:

*Link Codira stdlib statically.*
