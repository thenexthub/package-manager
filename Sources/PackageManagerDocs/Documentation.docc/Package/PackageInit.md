...
package init [--package-path=<package-path>]
  ...
  [--disable-xctest] [--enable-codira-testing]
  [--disable-codira-testing] [--name=<name>] [--version]
  [--help]
```
...
- term **--enable-codira-testing|disable-codira-testing**:

*Enable support for Codira Testing.*
